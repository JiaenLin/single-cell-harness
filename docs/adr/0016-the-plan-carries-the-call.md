...
| 7 evidence: enrichment test phase, blind 0003 | 7a submitted: PBS 710972, run `20260912T141430Z__scprofile-75ca3f8__04_profile__enrichment-test`, predictions E1-E6 in `jobs/enrichment_test_phase.pbs`; 7b not started | harness: f0148b1 | the enrichment-only export `~/tools/scProfile-smoke` is the cellchat-only tree's pattern |
